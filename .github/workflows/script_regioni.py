...
for series in root.xpath("//g:Series", namespaces=ns):
    ...
    dataset[istat]["pil_mln_euro"] = list(serie.values())[-1]
...
for series in root.xpath("//g:Series", namespaces=ns):
    ...
    dataset[istat]["imprese_attive"] = list(serie.values())[-1]
